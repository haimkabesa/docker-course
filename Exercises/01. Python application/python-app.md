...
---
# Exercise 1 - Dockerizing python application
...
1. Create an empty project directory.
    ...
    You can name the directory something easy for you to remember (for example: py-app). This directory is the context for your application image. The directory should only contain resources to build that image.
...
2. Create a new file called `Dockerfile` in your project directory.
    ...
    and the [Dockerfile reference](https://docs.docker.com/engine/reference/builder/#understand-how-arg-and-from-interact).
...
the [docker-compose run](https://docs.docker.com/compose/reference/run/) command as follows.
...
3. After the `docker-compose` command completes, list the contents of your project.
    ...
    If you are running Docker on Linux, the files `manage.py` created are
    owned by root. This happens because the container runs as the root user.
    Change the ownership of the new files. In the root directory of your project, run the following command:
...
4.  Run the [docker-compose up](https://docs.docker.com/compose/reference/up/) command from the top level directory for your project.
